...
3. **All Backend Tests**
   ...
   - test_purpose: "Validates all backend functionality including OpenFX API integration, data models, price data processing, and API endpoints"
...
[
  {
    ...
    "test_purpose": "Validates JavaScript compilation, module resolution, and production build process for the React frontend application",
    "error": "Module not found: Can't resolve './components/Example'"
  },
  {
    "test_name": "all_backend_tests",
    "passed": true,
